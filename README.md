...
> **Alpha (`0.1.8`).** The package surface is implemented and tested, but the emitted HTML/CSS contract may evolve before `1.0.0`.
...
Non-optional peers: `react >=19.0.0`, `react-dom >=19.0.0`, `@puckeditor/core ^0.22.0`. Only `@anvilkit/core` is a runtime dependency.
